...
// Protocollo web service Apple Wallet — estratto in apple-wallet-protocol.js.
// Il mount resta QUI: /passes/:passTypeId/:serialNumber deve matchare dopo le
// route /passes/:id/* registrate sopra (stesso numero di segmenti).
router.use(require('./apple-wallet-protocol'));
...
// Endpoint pubblici dei giochi (instant win + gamification) — estratti in
// game-routes.js. Prefissi /play e /game: nessun'altra route li usa, il
// raggruppamento qui non altera il matching.
...
// Webhook e link Samsung Wallet — estratti in samsung-wallet-webhooks.js.
router.use(require('./samsung-wallet-webhooks'));
