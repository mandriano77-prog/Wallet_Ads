...
test('Apple HR pass applies Wallet lock-screen copy on changed header announcement field', () => {
  ...
  assert.match(employeePass, /headerFields\.push\(employeePass\.pushAlert\)/);
